...
| **0.3.4** | Registering — restore `CausalMediation` weakdep + extension (CM **0.1.0** on General, [#163653](https://github.com/JuliaRegistries/General/pull/163653)) |
...
4. Wait for General AutoMerge; TagBot tags `v0.3.4`
